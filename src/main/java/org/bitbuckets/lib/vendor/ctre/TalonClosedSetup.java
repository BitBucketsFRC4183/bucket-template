...
public class TalonClosedSetup implements ISetup<IMotorController> {
    ...
    final boolean positionOrVelocity;
    final int canId;
    ...
    /**
     *
     * @param positionOrVelocity true for position, false for velocity
     * @param canId
     ...
     * @param pidConstants
     */
    public TalonClosedSetup(boolean positionOrVelocity, int canId, double selfToMechanismFactor, double currentLimit, double[] pidConstants) {
        this.positionOrVelocity = positionOrVelocity;
        this.canId = canId;
    ...
    public IMotorController build(IProcessPath path) {
        ...
        TalonMotor motor = new TalonMotor(talon, positionOrVelocity ? ControlMode.Position : ControlMode.Velocity);
