...
class TalonFXProfile extends CTREPhysicsSim.SimProfile {
     ...
     */
    public TalonFXProfile(final TalonFX talon, final double accelToFullTime, final double fullVel, final boolean sensorPhase) {
        this._talon = talon;
