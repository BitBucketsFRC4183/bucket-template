...
public interface DriveConstants {
    ...
    //TODO divide by 2
    double REVS_TO_RADS = (2.0 * Math.PI);
    ...
    //su -> revs -> radians
    double TURN_FACTOR_FX_POS = (1/SENSOR_UNITS_PER_REVOLUTION) * REVS_TO_RADS;
    ...
    double TURN_FACTOR_HALL_POS = ROTATION_REDUCTION * REVS_TO_RADS; //give me radians!
    double TURN_FACTOR_HALL_VEL = TURN_FACTOR_HALL_POS / 60; //give me radians / time! or something
    double TURN_FACTOR_ABS_POS = (1/3.3) * REVS_TO_RADS; //give me radians!
