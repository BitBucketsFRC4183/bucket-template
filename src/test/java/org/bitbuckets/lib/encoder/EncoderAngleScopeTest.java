...
import org.bitbuckets.drive.module.EncoderAngleScope;
...
class EncoderAngleScopeTest {
    ...
    void calculateOptimalSetpointRadiansForward() {
        ...
        EncoderAngleScope encoderAngleScope = new EncoderAngleScope(mock);
        double setpoint = encoderAngleScope.optimizeSetpointWithMechanismRads_encoderRads(0.5 * Math.PI);
    ...
    void calculateOptimalSetpointRadiansBackwards() {
        ...
        EncoderAngleScope encoderAngleScope = new EncoderAngleScope(mock);
        double setpoint = encoderAngleScope.optimizeSetpointWithMechanismRads_encoderRads(1.5 * Math.PI);
    ...
    void calculateOptimalSetpoint_shouldBeIntelligent() {
        ...
        IRotationEncoder mock = new TalonRotationEncoder(gearRatio, () -> 4096.0, null);
        EncoderAngleScope encoderAngleScope = new EncoderAngleScope(mock);
    ...
    void calculateOptimalSetpoint_shouldGoBackwards() {
        ...
        double setpoint = encoderAngleScope.optimizeSetpointWithMechanismRads_encoderRads(0.25 * Math.PI); //we want to move 1/2 pi encoder radians
